...
<script type="text/javascript">
	...
	function fHwSubForm(object) {
		...
		if( object == "" || object == null || object == undefined) {
			...
			$('#hws_name').attr("readonly", false);
			$('#hws_content').attr("readonly", false);
		...
		swal("정말 삭제하겠습니까? \n삭제시 복구불가합니다.", {
			  buttons:{
				...
				case "yes":
					...
					callAjaxFileUploadSetFormData("/lmg/deleteHwSub.do", "post", "json", true, fileData, resultCallback);
