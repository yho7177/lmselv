...
public class StatisticsController {
	...
	public void studentNum(Model model, @RequestParam Map<String, Object> paramMap) {
		int pageNo = 0;
		...
		System.out.println((String) paramMap.get("searchStart"));
		System.out.println((String) paramMap.get("searchEnd"));
		try {
			Map<String, Object> map = service.getStudentNumForClass(paramMap);
			...
			PagingInfo pi = (PagingInfo) map.get("pi"); // 페이징 객체
