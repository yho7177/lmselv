...
<script type="text/javascript">
  ...
  $(function() {
	  ...
	  console.log("${sessionScope.profile}");
    //fSelectMngrWorkStat();
  });
...
<div id="lnb_area">
  ...
  <div class="login">
  <!-- 프로필 사진 DB에서 가져와서 경로에 삽입 -->
    <img src="/filepath/profile/${sessionScope.profile}" class="LoginImg" alt="사진" />
      ...
      <li>
        <dl>
          ...
          <dd>
            ...
            <%-- <c:out value="${i}"></c:out> --%>
              <c:set var="urls" value="${fn:split(i.mnu_url, '/')}" />	<!-- 테스트용 -->
              <c:choose>
