...
public class LmgExamAServiceImpl implements LmgExamAService {
	...
	@Override
	public Map<String, Object> getTestList(Map<String, Object> paramMap) throws Exception {
		Map<String, Object> tmp = new HashMap<String, Object>();
		
		// 페이징
		PagingInfo pi = pagingProcess(paramMap);
		String l_no = (String) paramMap.get("l_no");
		tmp.put("l_no", l_no);
	...
	// 페이징 정보 가져오기 위한 메서드
	private PagingInfo pagingProcess(Map<String, Object> paramMap) throws Exception {
		PagingInfo pi = new PagingInfo();
	...
	// 시험 정보 수정하기 위한 정보 가져오기
	@Override
	public TestInfo getTestOne(Map<String, Object> paramMap) throws Exception {
		return dao.getTestOne(paramMap);
	}

	@Override
	public int updateTestInfo(Map<String, Object> paramMap) throws Exception {
		return dao.updateTestInfo(paramMap);
	}
