    ...
    <ul>
      ...
      <li class="contents">
        ...
        <div class="content">
          ...
          <br/>
          <div class="container">
            <form id="form_test" action="/board/insertBoard.do" method="post">
              <table class="table table-bordered" style="width: 450px;">
                <tbody>
                <tr>
                  <th>제목</th>
                  <td style="float: left; width: 900px;">
                  	<input type="hidden" name = "loginID" value="${loginId }" />
                    <input type="text" placeholder="제목을 입력하세요."
                             name="b_title" class="form-control" />
                </tr>
                <tr>
                  <th>내용</th>
                  <td style="height: 450px;"><textarea style="height: 450px;" placeholder="내용을 입력하세요 ." name="b_content"
