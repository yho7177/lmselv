...
<script type="text/javascript">
	...
	function fInitLmg(object) {
		...
		if( object == "" || object == null || object == undefined) {
			...
			$("#ci_goal").attr("readonly", true);
			$("#ci_attend").attr("readonly", true);
			$("#ci_limit").attr("readonly", true);
			$("#ci_plan").attr("readonly", true);
					...
					<li class="contents">
						...
						<div class="content">
							...
							<p class="Location">
								...
								<a href="../lmg/lecture.do" class="btn_set refresh">새로고침</a>
							</p>
